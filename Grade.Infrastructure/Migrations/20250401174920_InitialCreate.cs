    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    GradeHorarioId = table.Column<Guid>(type: "uuid", nullable: false),
                    MateriaId = table.Column<Guid>(type: "uuid", nullable: false),
                    ProfessorId = table.Column<Guid>(type: "uuid", nullable: false),
                    GradeHorarioId1 = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeHorarioMaterias", x => new { x.GradeHorarioId, x.ProfessorId, x.MateriaId });
                    table.ForeignKey(
                        name: "FK_GradeHorarioMaterias_GradeHorarios_GradeHorarioId",
                        column: x => x.GradeHorarioId,
                        principalTable: "GradeHorarios",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradeHorarioMaterias_GradeHorarios_GradeHorarioId1",
                        column: x => x.GradeHorarioId1,
                        principalTable: "GradeHorarios",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeHorarioMaterias_GradeHorarioId1",
                table: "GradeHorarioMaterias",
                column: "GradeHorarioId1");
